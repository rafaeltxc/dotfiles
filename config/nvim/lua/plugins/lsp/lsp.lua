local M = {
    ...
    dependencies = {
        "mason.nvim",
        {
            ...
            opts = {
                ensure_installed = require("utils.mason-ensure-installed"),
    ...
    config = function(_, opts)
        ...
        local servers = require("utils.mason-ensure-installed")
        if #servers > 0 then
            local setup = function(server)
                ...
                local require_ok, custom_opts = pcall(require, "plugins.lsp.settings." .. server)
                if require_ok then
